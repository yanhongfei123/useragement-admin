<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="dialogVisible4 = true">添加用户</el-button>
    </div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="showDialog(scope.row, 'dialogVisible3')">修改额度</el-button>
        </template>
      </el-table-column>
    ...
    <reset-password ref="resPas" :user-id="row.userId"/>

    <el-dialog :visible.sync="dialogVisible3" title="修改额度" width="30%">
      <!-- <el-input v-model="count" placeholder="请输入额度数" style="width:200px;" class="" /> -->
      <el-input-number v-model="count" :min="min" label="请输入额度数" style="width:200px;"/>
      <span slot="footer" class="dialog-footer">
    ...
    <el-dialog :visible.sync="dialogVisible4" title="添加用户" width="30%">
      <el-form ref="submitForm" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="姓名" prop="nickName" >
          <el-input v-model="form.nickName" name="nickName" autocomplete="off" type="text" style="width: 200px;" />
        </el-form-item>
        <el-form-item label="手机号" prop="mobile">
          <el-input v-model="form.mobile" name="mobile" autocomplete="off" type="text" style="width: 200px;" />
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input v-model="form.password" name="password" autocomplete="off" type="text" style="width: 200px;" />
        </el-form-item>
        <el-form-item label="分拥点数" prop="moneyRate" style="margin-bottom:0">
          <el-input v-model="form.moneyRate" name="moneyRate" autocomplete="off" type="text" style="width: 200px;" />
        </el-form-item>
        <el-form-item label="" >
...
export default {
  ...
  methods: {
    handleFilter(mobile, name) {
      var params = { mobile, name }
    ...
    countConfirm() {
      var { userId, money } = this.row
      money = money + this.count
      var params = {
        userId,
        money
      }
